...
public class MyNeighbourRecyclerViewAdapter extends RecyclerView.Adapter<MyNeighbourRecyclerViewAdapter.ViewHolder> implements Serializable {
    ...
    String EXTRA_NEIGHBOUR = "click_neighbour";
    ...
    private void goToDetailActivity(Neighbour neighbour) {
        intent = new Intent (context,DetailNeighbourActivity.class);

        // Implements Serializable --> Here + neighbour
